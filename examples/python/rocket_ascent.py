...
- Full 6DOF rigid body dynamics (RigidBody6DOF component)
- Force/mass aggregation (ForceAggregator, MassAggregator)
...
def main():
    print_header("Icarus Rocket Ascent Demo")
    ...
    lat = sim['Rocket.EOM.position_lla.lat']
    lon = sim['Rocket.EOM.position_lla.lon']
    ...
    # Mass properties
    total_mass = sim['Rocket.Mass.total_mass']
    ...
    alt_final = sim['Rocket.EOM.position_lla.alt']
    vx_final = sim['Rocket.EOM.velocity_body.x']
    vy_final = sim['Rocket.EOM.velocity_body.y']
    vz_final = sim['Rocket.EOM.velocity_body.z']
    mass_final = sim['Rocket.Mass.total_mass']
    ...
    omega_x = sim['Rocket.EOM.omega_body.x']
    omega_y = sim['Rocket.EOM.omega_body.y']
    omega_z = sim['Rocket.EOM.omega_body.z']
